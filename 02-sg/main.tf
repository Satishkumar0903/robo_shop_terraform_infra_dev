module "vpn" {
  source         = "git::https://github.com/Satishkumar0903/terraform_aws_security_group.git?ref=main"
...
#catalogue accepting connections from vpn_http
